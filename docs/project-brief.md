...
- Driver app authentication depth after route+phone lookup: route access lookup and consent record persistence are available; assigned-route session depth remains pending
