...
- Driver app authentication depth after route+phone lookup: route access lookup, consent record persistence, and assigned-route read API are available; route+phone session/token issuance depth remains pending
